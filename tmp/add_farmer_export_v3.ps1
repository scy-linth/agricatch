...
"@
# Insert after the closing brace of refreshOverviewMetricsSoon, before formatLocalDateInputValue
$content = $content -replace '(refreshOverviewMetricsSoon\(\) \{[^}]+\}\s+)(formatLocalDateInputValue)', '$1$insert$2'
