ALTER TABLE users ADD COLUMN IF NOT EXISTS first_name VARCHAR(40);
ALTER TABLE users ADD COLUMN IF NOT EXISTS middle_name VARCHAR(40);
ALTER TABLE users ADD COLUMN IF NOT EXISTS last_name VARCHAR(40);
