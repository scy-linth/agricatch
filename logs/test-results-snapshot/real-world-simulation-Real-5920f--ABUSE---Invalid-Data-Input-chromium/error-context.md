...
- Name: real-world-simulation.spec.js >> Real World Simulation - Access Control & Abuse Testing >> ABUSE - Invalid Data Input
- Location: tests\real-world-simulation.spec.js:516:3
...
Call log:
  - waiting for locator('input, textarea, select').nth(1)
    - locator resolved to <select class="mf-sort-select" id="global-sort-select">…</select>
    - fill("INVALID_TEST_DATA_<>{}")
...
- generic [ref=e1]:
  ...
  - generic [ref=e79]:
    ...
    - generic [ref=e83]:
      - generic [ref=e84]:
        - generic: 
        - textbox "Search products..." [active] [ref=e85]: "INVALID_TEST_DATA_<>{}"
      - generic [ref=e86]:
