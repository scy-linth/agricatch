...
- Name: real-world-simulation.spec.js >> Real World Simulation - Access Control & Abuse Testing >> UI CONSISTENCY - Buttons, Colors, Badges, Tabs, Tables, Cards, Modals
- Location: tests\real-world-simulation.spec.js:312:3
