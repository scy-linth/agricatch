...
(async function(){
  try{
    const testAccounts = [
      { email: 'scy@linth', username: 'scy_linth' },
      { email: 'testadmin@test.com', username: 'testadmin' },
      { email: 'testfarmer@test.com', username: 'testfarmer' },
      { email: 'testcustomer@test.com', username: 'testcustomer' }
    ];
    
    console.log('Checking test account passwords:');
    console.log('');
